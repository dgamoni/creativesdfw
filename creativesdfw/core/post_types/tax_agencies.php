<?php
if ( ! function_exists( 'tax_agencies' ) ) {

// Register Custom Taxonomy
function tax_agencies() {

	$labels = array(
		'name'                       => _x( 'Agencies', 'Agencies', 'wp-bootstrap-starter-creativesdfw' ),
		'singular_name'              => _x( 'Agencies', 'Agencies', 'wp-bootstrap-starter-creativesdfw' ),
		'menu_name'                  => __( 'Agencies', 'wp-bootstrap-starter-creativesdfw' ),
	...
	register_taxonomy( 'agencies', array( 'profile' ), $args );

}
add_action( 'init', 'tax_agencies', 0 );
