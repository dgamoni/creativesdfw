<?php
if ( ! function_exists( 'tax_creatives' ) ) {

// Register Custom Taxonomy
function tax_creatives() {

	$labels = array(
		'name'                       => _x( 'Creatives', 'Creatives', 'wp-bootstrap-starter-creativesdfw' ),
		'singular_name'              => _x( 'Creatives', 'Creatives', 'wp-bootstrap-starter-creativesdfw' ),
		'menu_name'                  => __( 'Creatives', 'wp-bootstrap-starter-creativesdfw' ),
	...
	register_taxonomy( 'creatives', array( 'profile' ), $args );

}
add_action( 'init', 'tax_creatives', 0 );
