		        ...
		        <div class="pricecard mb-5 mb-lg-0">
		          <div class="pricecard-body">
				        ...
				        <div class="sign-up-now">
				        	<a href="<?php if($price_name == 'free listing'){ echo home_url('/add-profile/'); } else { echo home_url('/sign-up/').'?type=agencies&plan='.$price_name; } ?>" class="btn btn-block btn-primary ">
